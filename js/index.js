...
let weekWaves = "";
    ...
    if (pathName.includes("kingisland.html")) {
        ...
        getProjectVariables(localTime, currentWaves, weekWaves);
    } 
    //urls for kaneohe bay
    else if (pathName.includes("kaneohebay.html")) {
...
//Function for get requests for ocean wave project pages (King Island & Kaneohe Bay)

function getProjectVariables(localTime, currentWaves, weekWaves) {
